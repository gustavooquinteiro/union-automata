#include "../../lib/automata/e-non-deterministic-automata.h"
EpsilonNonDeterministic:: EpsilonNonDeterministic(){
	...
	cout << "Insira todas as transições do automato (para transições lambda insira o caracter #): " << endl;
